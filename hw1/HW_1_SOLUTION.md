...
Как уже было сказано в предыдущем пункте, основной боттлнек - пулл коннектов. В качестве решения могу предложить connection pooling proxy. Тут используется postgresql, поэтому можно использовать PgBouncer или аналогичный
